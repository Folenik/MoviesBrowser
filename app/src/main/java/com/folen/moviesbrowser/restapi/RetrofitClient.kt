...
import com.folen.moviesbrowser.utilities.ApiKey
...
interface RetrofitClient {
    companion object {
        const val getMoviesRequest =
            "now_playing?api_key=${ApiKey.API_KEY}&language${ConstantValues.DEFAULT_LANGUAGE}&page=${ConstantValues.PAGE_REQUEST}"
